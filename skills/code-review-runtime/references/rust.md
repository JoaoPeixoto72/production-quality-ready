...
(`observability`) e código de saída não-zero. Nunca engolir com `let _ =`
...
- Um teste por risco enumerado; a matriz risco→teste vive em
  `docs/VERIFICAR.md` ou equivalente do projecto (é reliability/observability
